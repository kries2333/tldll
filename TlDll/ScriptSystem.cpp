...
void CScriptSystem::LUA_ScriptSystemInitial(/*CString strScriptName*/)
{
	...
	objGlobal.Register("自动恢复", *MeLua,
		&CMeLua::LUA_AutoRoleStatus);//移动到NPC

	objGlobal.Register("自动存储", *MeLua,
		&CMeLua::LUA_AutoStorage);//移动到NPC

	//	//任务类的成员函数注册到原表中	
	//objGlobal.Register("QuestFrameOptionClicked", *MeLua,
	//	&CMeLua::LUA_QuestFrameOptionClicked);//点击对话选项

	//objGlobal.Register("QuestFrameMissionContinue", *MeLua,
	//	&CMeLua::LUA_QuestFrameMissionContinue);//继续

	//objGlobal.Register("QuestFrameMissionComplete", *MeLua,
	//	&CMeLua::LUA_MissionContinue_Clicked);//完成

	//objGlobal.Register("QuestFrameAcceptClicked", *MeLua,
	//	&CMeLua::LUA_MissionQuestAccept_Clicked);//接受

	//objGlobal.Register("Quest_OnHidden", *MeLua,
	//	&CMeLua::LUA_Quest_OnHidden);//关闭对话选项

	//objGlobal.Register("KillMonsterByName", *MeLua,
	//	&CMeLua::LUA_KillMonsterByName);//名称杀怪，可以指定怪物的颜色

	//objGlobal.Register("KillAnyMonster", *MeLua,
	//	&CMeLua::LUA_KillAnyMonster);//杀怪，可以指定怪物的颜色
